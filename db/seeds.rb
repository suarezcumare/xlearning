...
#Asignacion_grupos
Asignacion_grupo.create!([{fecha_habilitacion:"15/02/28", fecha_cierre: "15/03/12"},{fecha_habilitacion:"15/03/28", fecha_cierre: "15/04/12"},
	{fecha_habilitacion:"15/03/23", fecha_cierre: "15/03/30"},{fecha_habilitacion:"15/02/28", fecha_cierre: "15/04/12"}])
#
#Cursos
Curso.create!([
  ...
  {nombre: "Desarrollo Orientado a Objetos", descripcion: "El modelo vista controlador es uno de los mas implementados para el desarrollo orientado a objetos", objetivos: "Mejorar la calidad del software brindando mayor rapidez al manejo de la base de datos", prerequisitos: "Nociones basicas para el MVC", perfil_estudiante: "Desarrollar programas seguros", pago: true, costo: 1000.0, matricula_maxima: 70, puntaje_aprobacion: 80.0, horas_semanales: 5, estatus: true},
  {nombre: "Desarrollo web con Ruby", descripcion: "El desarrollo web es de real importancia para lo que es la administracion de online de entidades bancarias,entidades de comunicacion, entre otros", objetivos: "Brindar servicios web ", prerequisitos: "Desarrollar programas seguros al alcance de nuestros clientes", perfil_estudiante: "Brindar seguridad", pago: true, costo: 1300.0, matricula_maxima: 100, puntaje_aprobacion: 85.0, horas_semanales: 6, estatus: true},
   {nombre: "Logica de la matematica", descripcion: "Manejar numeros de manera rapida y practica, para mejorar la habilidad en la matematica ", objetivos: "Manejar ciertos calculos como las integrales", prerequisitos: "Tener cierta logica para la matematica", perfil_estudiante: "Ser constante a la hora de practicar con los numeros, para asi mejorar y mantenerse al nivel del curso", pago: true, costo: 1550.0, matricula_maxima: 100, puntaje_aprobacion: 85.0, horas_semanales: 6, estatus: true}
{nombre: "Logica de la fisica", descripcion: "Manejar numeros de manera rapida y practica, para mejorar la habilidad en la matematica ", objetivos: "Manejar ciertos calculos como las integrales", prerequisitos: "Tener cierta logica para la matematica", perfil_estudiante: "Ser constante a la hora de practicar con los numeros, para asi mejorar y mantenerse al nivel del curso", pago: true, costo: 1550.0, matricula_maxima: 100, puntaje_aprobacion: 85.0, horas_semanales: 6, estatus: true}
...
{nombre: "Interpretacion de lenguajes", descripcion: "Manejar numeros de manera rapida y practica, para mejorar la habilidad en la matematica ", objetivos: "Manejar ciertos calculos como las integrales", prerequisitos: "Tener cierta logica para la matematica", perfil_estudiante: "Ser constante a la hora de practicar con los numeros, para asi mejorar y mantenerse al nivel del curso", pago: true, costo: 1550.0, matricula_maxima: 100, puntaje_aprobacion: 85.0, horas_semanales: 6, estatus: true}
...
{nombre: "Visual Basic", descripcion: "Manejar numeros de manera rapida y practica, para mejorar la habilidad en la matematica ", objetivos: "Manejar ciertos calculos como las integrales", prerequisitos: "Tener cierta logica para la matematica", perfil_estudiante: "Ser constante a la hora de practicar con los numeros, para asi mejorar y mantenerse al nivel del curso", pago: true, costo: 1550.0, matricula_maxima: 100, puntaje_aprobacion: 85.0, horas_semanales: 6, estatus: true}
...
#Categoria
 ...
 #Curso_Categoria
Curso_Categoria.create!([{categoria_id:'3',curso_id:'3'},{categoria_id:'3',curso_id:'2'},{categoria_id:'1',curso_id:'1'},{categoria_id:'2',curso_id:'9'},
...
#critica_cursos
Critica_curso.create!([{contenido: "Buen curso", puntuacion: 10},{contenido:'mal curso', puntuacion: 5}])

#Entrega Asignaciones
...
#Evaluacion_grupos
Evaluacion_grupo.create!([{puntuacion: "15/01/17", fecha_cierre: "15/01/18"},{fecha_habilitacion: "15/02/02", fecha_cierre: "15/02/05"},
	{fecha_habilitacion: "15/02/15", fecha_cierre: "15/02/20"},{fecha_habilitacion: "15/03/10", fecha_cierre: "15/03/15"}])

#Evaluacion Presentada
Evaluacion_presentada.create!([{puntuacion: 8, fecha_presentacion: "15/01/18", feedback:"feedback"},{puntuacion: 10, fecha_presentacion: "15/02/05", feedback:"feedback"},
...
#item_resumen
Item_resumen.create!([{ titulo: "Resumen del curso", descripcion:"Descripcion del curso"},{titulo: "Resumen del curso", descripcion:"Descripcion del curso"}])

#Modos de pago
Modo_pago.create!([{ nombre: "Credito", descripcion:"Con tarjetas visa o mastercad"},{titulo: "Paypal", descripcion:"En divisas"}])
