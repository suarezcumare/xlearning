...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2015 a las 12:19:56
...
CREATE TABLE IF NOT EXISTS `asignacions` (
  ...
  KEY `index_asignacions_on_modulo_id` (`modulo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `autenticacions` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_autenticacions_on_usuario_id` (`usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `bitacora_usuarios` (
  ...
  `usuario_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_bitacora_usuarios_on_trackeable_id_and_trackeable_type` (`trackeable_id`,`trackeable_type`),
  KEY `index_bitacora_usuarios_on_tipo_evento_id` (`tipo_evento_id`),
  KEY `index_bitacora_usuarios_on_usuario_id` (`usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `contratos` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_contratos_on_organizacion_id` (`organizacion_id`),
  KEY `index_contratos_on_plan_id` (`plan_id`),
  KEY `index_contratos_on_frecuencia_pago_id` (`frecuencia_pago_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `estructura_oferta_academicas` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_estructura_oferta_academicas_on_padre_id` (`padre_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `evaluacions` (
  ...
  KEY `index_evaluacions_on_modulo_id` (`modulo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `item_estructura_oferta_academicas` (
  ...
  `padre_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_item_estructura_oferta_academicas_on_est_oferta_acad_id` (`est_oferta_acad_id`),
  KEY `index_item_estructura_oferta_academicas_on_padre_id` (`padre_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `mensajes` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_mensajes_on_grupo_id` (`grupo_id`),
  KEY `index_mensajes_on_usuario_id` (`usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `notificacions` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_notificacions_on_notificble_id` (`notificble_id`),
  KEY `index_notificacions_on_usuario_id` (`usuario_id`),
  KEY `index_notificacions_on_tipo_notificacion_id` (`tipo_notificacion_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(73, 'Calendario', 1, '/calendario/profesor', NULL, 2, NULL, 4),
...
CREATE TABLE IF NOT EXISTS `organizacions` (
  ...
  `usuario_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_organizacions_on_pais_id` (`pais_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Volcado de datos para la tabla `organizacions`
--

INSERT INTO `organizacions` (`id`, `nombre`, `subdominio`, `estatus`, `logo`, `slogan`, `pais_id`, `direccion`, `descripcion`, `telefono1`, `telefono2`, `telefono3`, `telefono4`, `email1`, `email2`, `email3`, `email4`, `usuario_id`) VALUES
(3, 'mecanica en general', 'mecanica', NULL, NULL, NULL, NULL, NULL, 'mecanica', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3),
(4, 'Legurme', 'cocina', NULL, NULL, NULL, NULL, NULL, 'Cocina Internacional', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4);
...
CREATE TABLE IF NOT EXISTS `organizacion_red_socials` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_organizacion_red_socials_on_organizacion_id` (`organizacion_id`),
  KEY `index_organizacion_red_socials_on_red_social_id` (`red_social_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pago_contratos` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_pago_contratos_on_usuario_id` (`usuario_id`),
  KEY `index_pago_contratos_on_contrato_id` (`contrato_id`),
  KEY `index_pago_contratos_on_modo_pago_id` (`modo_pago_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `perfils` (
  ...
  KEY `index_perfils_on_pais_id` (`pais_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(3, 'suarezcumare@gmail.com', '$2a$10$wkNkN.8QOXGeMlvytvn.kunw/PaxBy/CEecDM23khtf7Q8xLPwIO.', 'Tony', 'Suarez', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `usuario_red_socials` (
  ...
  `valor` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_usuario_red_socials_on_usuario_id` (`usuario_id`),
  KEY `index_usuario_red_socials_on_red_social_id` (`red_social_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
